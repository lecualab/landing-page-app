...
@Component({
  ...
  template: `
    ...
    <div
      ...
      class="@container relative isolate aspect-square overflow-hidden rounded-md bg-dark-gray hover:grayscale-100 sm:aspect-auto sm:h-76 lg:h-108"
    >
      ...
      <div
        class="absolute h-full w-full bg-gradient-to-b from-transparent from-50% to-black"
      ></div>
      <div
